...
public class GameBoard {
    ...
    /**
     * This constructor creates a GameBoard object based on the input file given
     * as an argument. It reads data from the input file and provides lines
     * that, when uncommented, will display exactly what has been read in from
     * the input file. You can find these lines by looking for
     *
     ...
     * efficient.
     *
     * @param player the player whose score is being requested. valid values are
     * 1 or 2
